    	...
    	<div class="section group">
				<div class="col span_2_of_3">
				  <div class="message-form">
				  	<h2>留言</h2>
            <form  name="comment" action="testup.php" method="post" >
					    	<div>
						    	<span><label>姓名</label></span>
						    	<span><input name="Name" type="text" class="textbox" value="<?php if(!empty($_SESSION['name']))echo $_SESSION['name']; ?>" readonly = true; ></span>
						    </div>
						    <div>
						    	<span><label>留言</label></span>
						    	<span><textarea  type="text" name="Message" ></textarea></span>
						    </div>
						   <div>
						   		<span><input type="button"  value="送出留言" class="mybutton" onClick="check()"></span>
						  </div>
					    </form>
				  </div>
  				</div>
